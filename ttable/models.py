...
class Student(models.Model):
    ...
    grades=models.IntegerField(choices=GRADE_ITEMS,verbose_name="学阶")
    classes=models.IntegerField(choices=CLASS_ITEMS,verbose_name="年级")
...
class WechatLoginView(APIView):
    ...
    def WXLogin(self, request):
        ...
        try:
            ...
            #创建过程
            user = User.objects.create(username=username, nickname=nickname, avatar_url=avatar_url,gender=gender,password="")
